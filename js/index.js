(() => {
  ...
  var baseURL = "https://pierredewilde.github.io/hugo-acme";
  var hideForm = false;
  var maxSearch = 5;
  var relURL = "/hugo-acme";
  var timeout = 3;
  var params_default = { baseURL, hideForm, maxSearch, relURL, timeout };

  // ns-hugo:/home/runner/work/hugo-acme/hugo-acme/themes/acme/assets/js/formHandler.js
  ...
  // ns-hugo:/home/runner/work/hugo-acme/hugo-acme/themes/acme/assets/js/fuse.js
  function t(t2) {
    return Array.isArray ? Array.isArray(t2) : o(t2) === "[object Array]";
  }
  function e(t2) {
  ...
  function l(n2) {
    let s2 = null, i2 = null, r2 = null, c2 = 1;
    if (e(n2) || t(n2))
    ...
    return { path: s2, id: i2, weight: c2, src: r2 };
  }
  function u(e2) {
    ...
    if (m2) {
      const t3 = function(t4 = [], e3 = g.minMatchCharLength) {
        ...
        for (let c3 = t4.length; r3 < c3; r3 += 1) {
          let c4 = t4[r3];
          c4 && s3 === -1 ? s3 = r3 : c4 || s3 === -1 || (i3 = r3 - 1, i3 - s3 + 1 >= e3 && n3.push([s3, i3]), s3 = -1);
        }
      ...
      return function(t3, { ignoreFieldNorm: e2 = g.ignoreFieldNorm }) {
        t3.forEach((t4) => {
          ...
          t4.matches.forEach(({ key: t5, norm: s3, score: i3 }) => {
            ...
            n2 *= Math.pow(i3 === 0 && r3 ? Number.EPSILON : i3, (r3 || 1) * (e2 ? 1 : s3));
          }), t4.score = n2;
        });
  ...
  q.version = "6.5.3", q.createIndex = m, q.parseIndex = function(t2, { getFn: e2 = g.getFn, fieldNormWeight: n2 = g.fieldNormWeight } = {}) {
  ...
  // ns-hugo:/home/runner/work/hugo-acme/hugo-acme/themes/acme/assets/js/search.js
  ...
  // <stdin>
  formHandler_default.init(params_exports);
  search_default.init(params_exports);
})();
